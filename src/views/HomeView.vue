<template>
	<main>
		<div class="main-bg bg-none">
			<div v-for="(project, index) in projects" :key="project.id" class="bg-layer blur" :style="{
...
.slider {
	...
	width: 100%;
	height: 100%;
	padding-top: calc(var(--padding-vertical) * 4);
...
.slider-img-item {
	...
	transition: opacity .5s ease-in-out, transform .5s ease-in-out, 
		height .5s ease-in-out, width .5s ease-in-out;
}
