<template>
	<nav class="mobile-menu">
		<div class="menu-header">
			<button class="mobile-header-btn mobile-header-close" @click="$emit('close')">
				<svg viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M19 5L5 19M5.00001 5L19 19" />
				</svg>
			</button>
			<router-link to="/foods" class="mobile-header-btn mobile-header-ticket">
		...
		<div class="socials">
			...
			<a href="https://tiktok.com/a4z.fr" target="_blank" aria-label="Tiktok">
