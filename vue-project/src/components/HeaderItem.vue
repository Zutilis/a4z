...
export default {
	...
	methods: {
		toggleHeaderContent() {
			this.isHeaderContentVisible = !this.isHeaderContentVisible;
		},
		closeMenu() {
			this.isHeaderContentVisible = false;
		},
	},
};
</script>
...
.header-content {
	...
	height: 100vh;
	opacity: 0;
	padding: 0 calc(var(--padding-horizontal) * 4);
	gap: 30px;
}

.header-content.active .header-bg {
	opacity: 1;
}
